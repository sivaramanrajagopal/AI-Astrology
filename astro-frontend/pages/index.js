                    ...
                    <>
                      ...
                      {loading ? (
                        <div style={{ textAlign: 'center', padding: '40px' }}>
                          <div style={styles.spinner}></div>
                          <p style={{ marginTop: '16px', color: '#64748b' }}>Calculating planetary positions...</p>
                        </div>
                      ) : result && result.chart ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
                          <p>No chart data available. Please generate an analysis first.</p>
                        </div>
                      )}
                    </>
                  )}
                  ...
                  {activeTab === "prediction" && (
                    <>
                      ...
                      {loading ? (
                        <div style={{ textAlign: 'center', padding: '40px' }}>
                          <div style={styles.spinner}></div>
                          <p style={{ marginTop: '16px', color: '#64748b' }}>Generating cosmic interpretation...</p>
                        </div>
                      ) : result && result.interpretation ? (
                        formatText(result.interpretation)
                      ) : (
                        <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
                          <p>No interpretation available. Please generate an analysis first.</p>
                        </div>
                      )}
                    </>
                  )}
                  ...
                  {activeTab === "career" && (
                    <>
                      ...
                      {loading ? (
                        <div style={{ textAlign: 'center', padding: '40px' }}>
                          <div style={styles.spinner}></div>
                          <p style={{ marginTop: '16px', color: '#64748b' }}>Analyzing career insights...</p>
                        </div>
                      ) : career ? (
                        formatText(career)
                      ) : (
                        <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
                          <p>No career insights available. Please generate an analysis first.</p>
                        </div>
                      )}
                    </>
                  )}
                  ...
                  {activeTab === "dasa" && (
                    <>
                      ...
                      {loading ? (
                        <div style={{ textAlign: 'center', padding: '40px' }}>
                          <div style={styles.spinner}></div>
                          <p style={{ marginTop: '16px', color: '#64748b' }}>Calculating Dasa timeline...</p>
                        </div>
                      ) : dasa ? (
                        <div style={{ overflowX: 'auto' }}>
                          <table style={styles.table}>
                        ...
                        <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
                          <p>No Dasa timeline available. Please generate an analysis first.</p>
                        </div>
                      )}
                    </>
                  )}
